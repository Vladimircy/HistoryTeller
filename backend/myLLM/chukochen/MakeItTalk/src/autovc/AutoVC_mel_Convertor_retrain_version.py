...
class AutoVC_mel_Convertor():
    ...
    def convert_wav_to_autovc_input(self, build_train_dataset=True, autovc_model_path=r'E:\Dataset\VCTK\stargan_vc\train_85_withpre1125000_local\360000-G.ckpt'):
        ...
        emb = np.loadtxt('autovc/retrain_version/emb.txt')
    ...
    def convert_single_wav_to_autovc_input_G_Emb(self, audio_filename,G,id_emb):
        ...
        emb_trg = torch.from_numpy(id_emb[np.newaxis, :].astype('float32')).to(device)
